...
export default function Portfolio() {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    const phoneNumber = "917888100410";
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-200">
      ...
      >
        <div className="absolute inset-0 z-0">
          <Image
            src="/vivid-blurred-colorful-background.jpg?height=1080&width=1920"
            alt="Hero Background"
            fill
          ...
          <div className="text-center animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <button
                ...
                className="px-8 py-3 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 text-white font-medium transition-transform hover:scale-105 flex items-center justify-center gap-2 group"
              >
                View My Work
                <ArrowRight
                  size={18}
              ...
              <button
                ...
                className="px-8 py-3 rounded-full border-2 border-white text-white font-medium transition-all hover:bg-white hover:text-gray-900"
              >
                Contact Me
              </button>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="relative h-80 md:h-96 rounded-lg overflow-hidden shadow-xl transform transition-transform hover:scale-105">
              <Image
                src="/bharat1.jpg?height=600&width=400"
                alt="Profile"
                fill
                className="object-cover"
              />
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                ...
                applications. With over 2 years of experience working on
                freelance projects, I specialize in creating responsive,
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                ...
                functional and aesthetically pleasing. I'm constantly learning
                new technologies and techniques to stay at the forefront of web
                development.
              </p>
              <div className="pt-4 flex flex-wrap gap-4">
                <button
                  onClick={() => scrollToSection("contact")}
                  className="px-6 py-2 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 text-white font-medium transition-transform hover:scale-105 flex items-center gap-2 group"
                >
                  Get In Touch
                  <ArrowRight
                    size={16}
                ...
                <a
                  href="/MyResume_page.jpg"
                  download
                  className="px-6 py-2 rounded-full border-2 border-blue-500 text-blue-500 font-medium transition-all hover:bg-blue-500 hover:text-white flex items-center gap-2 group"
                >
                  Download Resume
                  <svg
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
            {[
              ...
              { name: "React", icon: "Atom", level: "Advanced", color: "cyan" },
              {
                name: "Node.js",
                icon: "Server",
                level: "Intermediate",
              ...
              <div
                key={index}
                className="skill-card bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group relative overflow-hidden opacity-0 translate-y-8"
              >
                ...
                <div className="flex flex-col items-center text-center relative z-10">
                  <div
                    className={`w-16 h-16 rounded-full flex items-center justify-center mb-4  group-hover:scale-110 transition-all duration-300 group-hover:animate-icon-pulse overflow-hidden`}
                  >
                    <div className="icon-container  ">
                      ...
                      {skill.icon === "LayoutTemplate" && (
                        <svg
                          ...
                          strokeLinecap="round"
                          strokeLinejoin="round"
                          className="group-hover:animate-icon-pulse"
                        >
                          <rect
                            x="3"
                            y="3"
                  ...
                  <h3 className="text-lg font-semibold mb-1 group-hover:text-blue-500 transition-colors duration-300">
                    {skill.name}
                  </h3>
            ...
            {[
              {
                ...
                institution: "R.A. College, Washim",
                year: "2023 - 2026",
                description: "focused on web technologies and Development.",
              },
              {
                degree: "Higher Secondary Certificate",
                institution: "K.P. Jr. College, Washim",
                year: "2021 - 2023",
                description:
              ...
              },
              {
                ...
                institution: "Shri. Bakliwal Vidyalaya, Washim",
                year: "2021",
                description:
              ...
              >
                ...
                <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg shadow-md hover:shadow-lg transition-all hover:-translate-y-1">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              {
                title: "Tech Coding Round",
                issuer: "Logipool Infotech",
                date: "2025",
                image: "/Bharat-Thakare.png",
              },
              {
                title: "Ai and Robotics",
                issuer: "Great Learning",
                date: "2024",
                image: "/Robotics-Ai.jpg",
              },
              {
                title: "Robothon (Participation)",
                issuer: "SGBAU University",
                date: "2023",
                image: "/Robothon.jpg",
              },
            ].map((cert, index) => (
              <div
                key={index}
                className="bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-all hover:-translate-y-1 group"
              >
                ...
                <div className="p-6">
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="text-blue-500">{cert.date}</span>
                  </div>
                </div>
              </div>
            ))}
            ...
            {[
              {
                ...
                image: "/ECommerce.jpg?height=300&width=500",
              ...
              },
              {
                ...
                image: "/TASKManagement.jpg?height=300&width=500",
                tags: ["React", "Redux", "Express", "Socket.io"],
              },
              {
                title: "Portfolio Website",
                description:
                  "Modern portfolio website template with animations and responsive design.",
                image: "/Portfolio.jpg?height=300&width=500",
                tags: ["HTML", "Tailwind CSS", "JavaScript"],
              },
              {
                title: "Weather Application",
                description:
                  "Real-time weather forecasting app with location detection and interactive maps.",
                image: "/WEATHER.jpg?height=300&width=500",
                tags: ["React", "OpenWeather API", "Mapbox"],
              },
              {
                title: "Cricket Score Tracker",
                description:
                  "Live cricket score tracking application with player statistics and match history.",
                image: "/Cricket.jpg?height=300&width=500",
                tags: ["Vue.js", "Node.js", "MongoDB"],
              },
            ].map((project, index) => (
              <div
                key={index}
                className="bg-gray-50 dark:bg-gray-700 rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-all hover:-translate-y-2 group"
              >
            ...
            {[
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <button className="text-blue-500 font-medium flex items-center gap-1 group-hover:gap-2 transition-all">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="font-medium">+91 7888100410</div>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-full bg-blue-100 dark:bg-blue-900 flex items-center justify-center text-blue-500">
                  ...
                  <div>
                    ...
                    <div className="font-medium">
                      IUDP Colony Washim, Washim, Maharashtra
                    </div>
                  </div>
                </div>
              </div>
              <div className="mt-8 flex gap-4">
                <a
                  href="https://www.linkedin.com/in/bharatthakare017/"
                  target="_blank"
                  className="w-10 h-10 rounded-full bg-blue-100 dark:bg-blue-900 flex items-center justify-center text-blue-500 hover:bg-blue-500 hover:text-white transition-colors"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                ...
                <a
                  href="https://x.com/bharatthakare_"
                  target="_blank"
                  className="w-10 h-10 rounded-full bg-blue-100 dark:bg-blue-900 flex items-center justify-center text-blue-500 hover:bg-blue-500 hover:text-white transition-colors"
                >
                  <svg
                ...
                <a
                  href="https://github.com/bharatthakare"
                  target="_blank"
                  className="w-10 h-10 rounded-full bg-blue-100 dark:bg-blue-900 flex items-center justify-center text-blue-500 hover:bg-blue-500 hover:text-white transition-colors"
                >
                  <svg
                ...
                <a
                  href="https://www.instagram.com/bharat.thakare_"
                  target="_blank"
                  className="w-10 h-10 rounded-full bg-blue-100 dark:bg-blue-900 flex items-center justify-center text-blue-500 hover:bg-blue-500 hover:text-white transition-colors"
                >
                  <svg
            ...
            <div>
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500"
                      placeholder="bharatthakare017@gmail.com"
                    />
                  </div>
                </div>
                <div>
                ...
                <button
                  type="submit"
                  className="w-full px-6 py-3 rounded-lg bg-gradient-to-r from-blue-500 to-purple-600 text-white font-medium transition-transform hover:scale-105 flex items-center justify-center gap-2"
                >
                  Send Message
                  <Send size={18} />
                </button>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              ...
              <p className="mt-2 text-sm text-gray-400">
                &copy; {new Date().getFullYear()} Bharat Thakare. All rights
                reserved.
              </p>
            </div>
          </div>
